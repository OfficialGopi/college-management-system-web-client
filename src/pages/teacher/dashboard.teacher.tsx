...
import { Pie, Line } from "./../../components/ui/charts";
        ...
        <div className="flex-1 w-full">
          ...
          <main className=" w-full flex flex-col">
            ...
            >
              ...
              >
                <Typography variant="h6">Assignments Given</Typography>
                <Line height={"100%"} data={givenAssignments} />
              </Card>
            </Grid>
          </main>
        </div>
